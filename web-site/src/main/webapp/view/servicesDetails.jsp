	...
	<body>
		<div class="cd-nugget-info">
			<a href="${pageContext.request.contextPath}/services">
				<span>
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewbox="0 0 16 16" style="" xml:space="preserve">
