...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/project-reset.css"> <!-- CSS reset -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/project-style.css"> <!-- Resource style -->
		...
		<script src="${pageContext.request.contextPath}/resources/js/project-modernizr.js"></script> <!-- Modernizr -->
		<script src="${pageContext.request.contextPath}/resources/js/project-main.js"></script> <!-- Main -->
	...
	<body>
		...
		<section id="section1" class="cd-section">
			...
			<div id="sticker" onclick="location.href='${pageContext.request.contextPath}/projects/details'" >
		...
		<section id="section2" class="cd-section">
			<p>
				&ldquo;
					SIB es un sistema de inversi&oacute;n bursatil, implementado en el sector bancario para HSBC a nivel nacional.
					Tiene como objetivo mejorar la calidad de servicio brindado a los clientes, as&iacute; como la experiencia del usuario en el manejo del sistema.
					Esto sin dejar a un lado los est&aacute;ndares de seguridad para el grupo.
				&rdquo;
			</p>
		</section><!-- cd-section -->
